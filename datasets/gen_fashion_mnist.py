...
if __name__ == '__main__':
    mnist_dataset = datasets.FashionMNIST(train=True, root = '../data', download=True)
    data2save = '/h/field/DiffGAN/fashion_mnist' #'/mnt/ssd/data/fashion_mnist'
    ...
    for i in range(len(mnist_dataset)):
        ...
        image.save(os.path.join(data2save, f"{target}_{i}.JPEG"))
