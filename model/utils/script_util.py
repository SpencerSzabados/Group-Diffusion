"""
    File contains script for instantiating the unet model and noise scales with default
    values that can be overwritten by passed arguments.
"""
