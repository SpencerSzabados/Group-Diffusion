"""
    ...
    ## pfode models:
    OPENAI_LOGDIR=/home/checkpoints/temp/ python image_euler_likelihood.py --g_equiv False --g_input Z2_K --g_output C4_K --diff_type pfode --sampler heun --data_augment 0 --eqv_reg None --pred_type x --attention_resolutions 32,16,8 --class_cond True --channel_mult 1,2,4 --use_scale_shift_norm True --dropout 0.1 --ema_rate 0.999,0.9999,0.9999432189950708 --global_batch_size 128 --batch_size 128 --image_size 28 --lr 0.0001 --num_channels 64 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --schedule_sampler lognormal --use_fp16 False --weight_decay 0.0 --weight_schedule karras --save_interval 1000 --sampling_interval 1000 --model_path /home/checkpoints/Group-Diffusion/c4_mnist_pfode_ch124_r2/model032000.pt --data_dir /home/datasets/c4_mnist --num_samples 1 --steps 100 --repeats 1 --sde VESDE 
    OPENAI_LOGDIR=/home/checkpoints/temp/ python image_euler_likelihood.py --g_equiv True --g_input Z2_K --g_output C4_K --diff_type pfode --sampler heun --data_augment 0 --eqv_reg None --pred_type x --attention_resolutions 32,16,8 --class_cond True --channel_mult 1,2,4 --use_scale_shift_norm True --dropout 0.1 --ema_rate 0.999,0.9999,0.9999432189950708 --global_batch_size 128 --batch_size 128 --image_size 28 --lr 0.0001 --num_channels 64 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --schedule_sampler lognormal --use_fp16 False --weight_decay 0.0 --weight_schedule karras --save_interval 1000 --sampling_interval 1000 --model_path /home/checkpoints/Group-Diffusion/c4_mnist_eqv_pfode_ch124_r2/model011000.pt --data_dir /home/datasets/c4_mnist --num_samples 1 --steps 100 --repeats 1 --sde VESDE 
    
    ## ddim models:
    CUDA_VISIBLE_DEVICES=1 OPENAI_LOGDIR=/home/checkpoints/Group-Diffusion/temp/ python image_euler_likelihood.py --g_equiv True --g_input Z2_K --g_output C4_K --diff_type ddim --sampler ddim --data_augment 0 --eqv_reg None --pred_type x --attention_resolutions 32,16,8 --class_cond True --channel_mult 1,2,4 --use_scale_shift_norm True --dropout 0.1 --ema_rate 0.999,0.9999,0.9999432189950708 --global_batch_size 128 --batch_size 10 --image_size 28 --lr 0.0001 --num_channels 64 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --schedule_sampler lognormal --use_fp16 False --weight_decay 0.0 --weight_schedule karras --save_interval 1000 --sampling_interval 1000 --model_path /home/checkpoints/Group-Diffusion/c4_mnist_3000_eqv_ddim_ch124_r2/model020000.pt --data_dir /home/datasets/c4_mnist --num_samples 1 --steps 100 --repeats 1 --sde VPSDE
    CUDA_VISIBLE_DEVICES=1 OPENAI_LOGDIR=/home/checkpoints/Group-Diffusion/temp/ python image_euler_likelihood.py --g_equiv False --g_input Z2_K --g_output C4_K --diff_type ddim --sampler ddim --data_augment 0 --eqv_reg C4 --pred_type x --attention_resolutions 32,16,8 --class_cond True --channel_mult 1,2,4 --use_scale_shift_norm True --dropout 0.1 --ema_rate 0.999,0.9999,0.9999432189950708 --global_batch_size 128 --batch_size 10 --image_size 28 --lr 0.0001 --num_channels 64 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --schedule_sampler lognormal --use_fp16 False --weight_decay 0.0 --weight_schedule karras --save_interval 1000 --sampling_interval 1000 --model_path /home/checkpoints/Group-Diffusion/c4_mnist_6000_reg_ddim_ch124_r2/model016000.pt --data_dir /home/datasets/c4_mnist --num_samples 1 --steps 100 --repeats 1 --sde VPSDE
