"""
    ...
    File taken from: (https://github.com/yang-song/score_sde_pytorch/blob/main/sde_lib.py)
"""
...
class KarrasVESDE(SDE):
  def __init__(self, sigma_min=0.01, sigma_max=50, rho=7.0, N=1000):
    """Construct a Variance Exploding SDE.
    ...
    self.discrete_sigmas = self.get_sigmas_karras(self.N)
  ...
  def discretize(self, x, t):
    ...
    f = torch.zeros_like(x)
    G = 2*t
    # G = torch.sqrt(sigma ** 2 - adjacent_sigma ** 2) # DEBUG: Should this be just t**2
    return f, G